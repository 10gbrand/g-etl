-- Staging: Sumpskogar
-- Sumpskogar från skogsstyrelsen, kod 114 i GISS
...
CREATE OR REPLACE TABLE staging.sumpskogar AS
WITH source_data AS (
    SELECT * FROM raw.sumpskogar
...
SELECT
    ...
    MD5(CAST(s.kartid2 AS VARCHAR)) AS _source_id_md5,
