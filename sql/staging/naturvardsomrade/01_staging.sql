-- Staging: Naturvardsomrade
-- Naturvardsomrade från naturvardsverket, kod 118 i GISS
...
CREATE OR REPLACE TABLE staging.naturvardsomrade AS
WITH source_data AS (
    SELECT * FROM raw.naturvardsomrade
...
SELECT
    ...
    MD5(CAST(s.NVRID AS VARCHAR)) AS _source_id_md5,
