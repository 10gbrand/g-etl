-- Staging: Dikningsforetagskartan
-- Dikningsföretag för skogsmark
...
CREATE OR REPLACE TABLE staging.dikningsforetagskartan AS
WITH source_data AS (
    SELECT * FROM raw.dikningsforetagskartan
