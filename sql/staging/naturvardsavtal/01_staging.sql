-- Staging: Naturvardsavtal
-- Naturvardsavtal från naturvardsverket, kod 104 i GISS
...
CREATE OR REPLACE TABLE staging.naturvardsavtal AS
WITH source_data AS (
    SELECT * FROM raw.naturvardsavtal
...
SELECT
    ...
    MD5(CAST(s.geodb_oid AS VARCHAR)) AS _source_id_md5,
