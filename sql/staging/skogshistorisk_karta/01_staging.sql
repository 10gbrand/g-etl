-- Staging: Skogshistorisk_karta
-- Skogshistoriska data från Skogsstyrelsen
...
CREATE OR REPLACE TABLE staging.skogshistorisk_karta AS
WITH source_data AS (
    SELECT * FROM raw.skogshistorisk_karta
