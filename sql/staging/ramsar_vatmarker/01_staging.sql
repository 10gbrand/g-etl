-- Staging: Ramsar_vatmarker
-- Ramsar-våtmarker (internationellt skyddade)
...
CREATE OR REPLACE TABLE staging.ramsar_vatmarker AS
WITH source_data AS (
    SELECT * FROM raw.ramsar_vatmarker
...
SELECT
    ...
    MD5(CAST(s.RAMSAR_ID AS VARCHAR)) AS _source_id_md5,
