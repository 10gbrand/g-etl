-- Staging: Biotopskydd_SKS
-- Biotopskydd från skogsstyrelsen, kod 105 i GISS
...
CREATE OR REPLACE TABLE staging.biotopskydd_sks AS
WITH source_data AS (
    SELECT * FROM raw.biotopskydd_sks
...
SELECT
    ...
    MD5(CAST(s.uuid AS VARCHAR)) AS _source_id_md5,
