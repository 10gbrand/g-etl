-- Staging: Nyckelbiotoper
-- Nyckelbiotoper från skogsstyrelsen, kod 112 i GISS
...
CREATE OR REPLACE TABLE staging.nyckelbiotoper AS
WITH source_data AS (
    SELECT * FROM raw.nyckelbiotoper
