-- Staging: torvlagerfoljder
-- torvlagerfoljder från SGU, kod 116 i GISS
-- Källa: sgu
--
...
CREATE OR REPLACE TABLE staging.torvlagerfoljder AS
WITH source_data AS (
    SELECT * FROM raw.torvlagerfoljder
...
SELECT
    ...
    -- MD5-hash av käll-ID (SGU använder fid)
