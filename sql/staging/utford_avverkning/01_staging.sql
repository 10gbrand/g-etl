-- Staging: Utford_avverkning
-- Utförda avverkningar från Skogsstyrelsen
...
CREATE OR REPLACE TABLE staging.utford_avverkning AS
WITH source_data AS (
    SELECT * FROM raw.utford_avverkning
...
SELECT
    ...
    MD5(CAST(s.arendeid AS VARCHAR)) AS _source_id_md5,
