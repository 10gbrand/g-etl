-- Staging: Naturvardsavtal_SKS
-- Naturvardsavtal från skogsstyrelsen, kod 104 i GISS
...
CREATE OR REPLACE TABLE staging.naturvardsavtal_sks AS
WITH source_data AS (
    SELECT * FROM raw.naturvardsavtal_sks
...
SELECT
    ...
    -- MD5-hash av käll-ID (Skogsstyrelsen använder arendeid)
    MD5(CAST(s.beteckn AS VARCHAR)) AS _source_id_md5,
