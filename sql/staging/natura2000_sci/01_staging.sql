-- Staging: Natura2000_SCI
-- Natura2000 från naturvardsverket, kod 103 i GISS
...
CREATE OR REPLACE TABLE staging.natura2000_sci AS
WITH source_data AS (
    SELECT * FROM raw.natura2000_sci
...
SELECT
    ...
    MD5(CAST(s.SITE_CODE AS VARCHAR)) AS _source_id_md5,
