-- Staging: StorNyckelbiotoper
-- Storskogsbrukets Nyckelbiotoper från skogsstyrelsen, kod 113 i GISS
...
CREATE OR REPLACE TABLE staging.stornyckelbiotoper AS
WITH source_data AS (
    SELECT * FROM raw.stornyckelbiotoper
