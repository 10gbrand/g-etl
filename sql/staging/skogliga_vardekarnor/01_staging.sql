-- Staging: Skogliga_vardekarnor
-- Skogliga värdekärnor nationell analys (314 MB)
...
CREATE OR REPLACE TABLE staging.skogliga_vardekarnor AS
WITH source_data AS (
    SELECT * FROM raw.skogliga_vardekarnor
