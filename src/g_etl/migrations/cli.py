...
def cmd_status(args: argparse.Namespace) -> int:
    ...
    print()
    num_static = len(static_migrations)
    num_applied = len(applied_static)
    num_pending = len(pending_static)
    print(f"Statiska: {num_static} ({num_applied} körda, {num_pending} väntande)")
