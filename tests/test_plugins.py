...
from g_etl.plugins import PLUGINS, get_plugin
...
class TestZipGeoPackagePlugin:
    ...
    def test_clear_download_cache_import(self):
        ...
        from g_etl.plugins.zip_geopackage import clear_download_cache
    ...
    def test_get_url_lock(self):
        """Testa URL-lås."""
        from g_etl.plugins.zip_geopackage import _get_url_lock
