...
from scripts.sql_generator import DatasetConfig, SQLGenerator, get_generator, list_templates
...
class TestDatasetConfig:
    ...
    def test_from_dataset_yml(self, sample_dataset_config):
        ...
        config = DatasetConfig.from_dataset_yml(
            "test_dataset", sample_dataset_config
        )
